...
func (app *application) authenticate(w http.ResponseWriter, r *http.Request){
	...
	if err != nil {
		app.errorJSON(w, errors.New("invalid user"), http.StatusBadRequest)
		return
	}
...
func (app *application) getMovie(w http.ResponseWriter, r *http.Request) {
	...
	movie, err := app.DB.GetOneMovieByID(movieID)
	if err != nil {
		app.errorJSON(w, err)
	}
...
func (app *application) InsertMovieFromAPI(w http.ResponseWriter, r *http.Request) {
...
func (app *application) FindMovieSearch(w http.ResponseWriter, r *http.Request) {
    var requestPayload struct {
    ...
    movieAPI := app.getMovieAPI(requestPayload.SearchStr)

    app.writeJSON(w, http.StatusOK, movieAPI)
}
...
func (app *application) getMovieAPI (searchStr string) []models.MovieAPICatch {
	type MovieAPI struct {
		Page int `json:"page"`
		Results []models.MovieAPICatch `json:"results"`
	TotalPages int `json:"total_pages"`
	...
	req, err := http.NewRequest("GET", theUrl+"&query="+url.QueryEscape(searchStr), nil)
	fmt.Println(req)
	if err != nil {
		log.Println(err)
		return []models.MovieAPICatch{}
	}
...
func (app *application) UpdateMovie(w http.ResponseWriter, r *http.Request) {
	...
	movie , err := app.DB.GetOneMovieByID(payload.ID)
	if err != nil {
		app.errorJSON(w, err)
		return
	}
